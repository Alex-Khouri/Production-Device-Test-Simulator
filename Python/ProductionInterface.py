...
class AppGUI(QtWidgets.QMainWindow):
	def __init__(self, *args, **kwargs):
		...
		self.widget.setWindowIcon(QIcon("Images/rocket_lab_logo.jpg"))
		...
		self.pixmapLogo = QPixmap("Images/rocket_lab_logo.jpg")
		...
		# LAYOUT
		self.layout.addWidget(self.labelLogo,				0, 0, 6, 1)
		self.layout.addWidget(self.buttonStartTest,	 		6, 0, 1, 1)
		self.layout.addWidget(self.buttonCancelTest, 		7, 0, 1, 1)
