...
void getUserInput()
{
	...
	// ::localModel = "Device";
	// ::localSerial = "1";
	// ::localName = ::localModel + "_" + ::localSerial;
	// ::localPort = "8080";
	...
	std::cout << std::endl << "Activating production device with the following specifications:" << std::endl
